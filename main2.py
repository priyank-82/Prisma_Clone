...
st.markdown("<h1 style='text-align: center; color: White;'>Prisma Clone(Neural Style Transfer)</h1>",
            unsafe_allow_html=True)
st.markdown("<h3 style='text-align: right; color: Blue;'>by Priyank Mandal</h3>",
            unsafe_allow_html=True)
